...
export default function Pagination() {
  return (
    <div>
      <h2>Pagination</h2>
      <div>
        <h3 id="lists-and-objects">Lists &amp; Objects</h3>
        <p>
      ...
      <div>
        ...
        <p>
          Pages start at 1. You may get a particular page by adding <code>?page=2</code>
          to your URL. Each page has at most 25 results.
        </p>
      </div>
    </div>
  )
